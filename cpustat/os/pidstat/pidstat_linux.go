...
func (s *PerProcessStat) CPUUserUsage() float64 {
	o := s.Metrics
	return o.Utime.ComputeRate() / float64(linuxTicksInSec)
}

func (s *PerProcessStat) CPUKernalUsage() float64 {
	o := s.Metrics
	return o.Stime.ComputeRate() / float64(linuxTicksInSec)
}
